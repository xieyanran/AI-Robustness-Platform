...
ATTACK_RECIPE_NAMES = {
    "alzantot": "text.attack_recipes.GeneticAlgorithmAlzantot2018",
    "bae": "text.attack_recipes.BAEGarg2019",
    "bert-attack": "text.attack_recipes.BERTAttackLi2020",
    "faster-alzantot": "text.attack_recipes.FasterGeneticAlgorithmJia2019",
    "deepwordbug": "text.attack_recipes.DeepWordBugGao2018",
    "hotflip": "text.attack_recipes.HotFlipEbrahimi2017",
    "input-reduction": "text.attack_recipes.InputReductionFeng2018",
    "kuleshov": "text.attack_recipes.Kuleshov2017",
    "morpheus": "text.attack_recipes.MorpheusTan2020",
    "seq2sick": "text.attack_recipes.Seq2SickCheng2018BlackBox",
    "textbugger": "text.attack_recipes.TextBuggerLi2018",
    "textfooler": "text.attack_recipes.TextFoolerJin2019",
    "pwws": "text.attack_recipes.PWWSRen2019",
    "iga": "text.attack_recipes.IGAWang2019",
    "pruthi": "text.attack_recipes.Pruthi2019",
    "pso": "text.attack_recipes.PSOZang2020",
    "checklist": "text.attack_recipes.CheckList2020",
    "clare": "text.attack_recipes.CLARE2020",
    "a2t": "text.attack_recipes.A2TYoo2021",
}


BLACK_BOX_TRANSFORMATION_CLASS_NAMES = {
    "random-synonym-insertion": "text.transformations.RandomSynonymInsertion",
    "word-deletion": "text.transformations.WordDeletion",
    "word-swap-embedding": "text.transformations.WordSwapEmbedding",
    "word-swap-homoglyph": "text.transformations.WordSwapHomoglyphSwap",
    "word-swap-inflections": "text.transformations.WordSwapInflections",
    "word-swap-neighboring-char-swap": "text.transformations.WordSwapNeighboringCharacterSwap",
    "word-swap-random-char-deletion": "text.transformations.WordSwapRandomCharacterDeletion",
    "word-swap-random-char-insertion": "text.transformations.WordSwapRandomCharacterInsertion",
    "word-swap-random-char-substitution": "text.transformations.WordSwapRandomCharacterSubstitution",
    "word-swap-wordnet": "text.transformations.WordSwapWordNet",
    "word-swap-masked-lm": "text.transformations.WordSwapMaskedLM",
    "word-swap-hownet": "text.transformations.WordSwapHowNet",
    "word-swap-qwerty": "text.transformations.WordSwapQWERTY",
}


WHITE_BOX_TRANSFORMATION_CLASS_NAMES = {
    "word-swap-gradient": "text.transformations.WordSwapGradientBased"
}
...
CONSTRAINT_CLASS_NAMES = {
    ...
    #
    "embedding": "text.constraints.semantics.WordEmbeddingDistance",
    "sbert": "text.constraints.semantics.sentence_encoders.SBERT",
    "infer-sent": "text.constraints.semantics.sentence_encoders.InferSent",
    "thought-vector": "text.constraints.semantics.sentence_encoders.ThoughtVector",
    "use": "text.constraints.semantics.sentence_encoders.UniversalSentenceEncoder",
    "muse": "text.constraints.semantics.sentence_encoders.MultilingualUniversalSentenceEncoder",
    "bert-score": "text.constraints.semantics.BERTScore",
    #
    # Grammaticality constraints
    #
    "lang-tool": "text.constraints.grammaticality.LanguageTool",
    "part-of-speech": "text.constraints.grammaticality.PartOfSpeech",
    "goog-lm": "text.constraints.grammaticality.language_models.GoogleLanguageModel",
    "gpt2": "text.constraints.grammaticality.language_models.GPT2",
    "learning-to-write": "text.constraints.grammaticality.language_models.LearningToWriteLanguageModel",
    "cola": "text.constraints.grammaticality.COLA",
    #
    # Overlap constraints
    #
    "bleu": "text.constraints.overlap.BLEU",
    "chrf": "text.constraints.overlap.chrF",
    "edit-distance": "text.constraints.overlap.LevenshteinEditDistance",
    "meteor": "text.constraints.overlap.METEOR",
    "max-words-perturbed": "text.constraints.overlap.MaxWordsPerturbed",
    #
    # Pre-transformation constraints
    #
    "repeat": "text.constraints.pre_transformation.RepeatModification",
    "stopword": "text.constraints.pre_transformation.StopwordModification",
    "max-word-index": "text.constraints.pre_transformation.MaxWordIndexModification",
}


SEARCH_METHOD_CLASS_NAMES = {
    "beam-search": "text.search_methods.BeamSearch",
    "greedy": "text.search_methods.GreedySearch",
    "ga-word": "text.search_methods.GeneticAlgorithm",
    "greedy-word-wir": "text.search_methods.GreedyWordSwapWIR",
    "pso": "text.search_methods.ParticleSwarmOptimization",
}
...
GOAL_FUNCTION_CLASS_NAMES = {
    ...
    #
    "hardlabel-classification": "text.goal_functions.classification.HardLabelClassification",
    "targeted-classification": "text.goal_functions.classification.TargetedClassification",
    "untargeted-classification": "text.goal_functions.classification.UntargetedClassification",
    "input-reduction": "text.goal_functions.classification.InputReduction",
    #
    # Text goal functions
    #
    "minimize-bleu": "text.goal_functions.text.MinimizeBleu",
    "non-overlapping-output": "text.goal_functions.text.NonOverlappingOutput",
    "text-to-text": "text.goal_functions.text.TextToTextGoalFunction",
}


@dataclass
class AttackArgs:
    """Attack arguments to be passed to :class:`~text.Attacker`.
    ...
    Args:
        ...
        query_budget (:obj:`int`, `optional`, defaults to :obj:`None`):
            ...
            If not set, we use the query budget set in the :class:`~text.goal_functions.GoalFunction` object (which by default is :obj:`float("inf")`).
            .. note::
                Setting this overwrites the query budget set in :class:`~text.goal_functions.GoalFunction` object.
        ...
        log_to_visdom (:obj:`dict`, `optional`, defaults to :obj:`None`):
            If set, Visdom logger is used with the provided dictionary passed as a keyword arguments to :class:`~text.loggers.VisdomLogger`.
        ...
        log_to_wandb(:obj:`dict`, `optional`, defaults to :obj:`None`):
            If set, WandB logger is used with the provided dictionary passed as a keyword arguments to :class:`~text.loggers.WeightsAndBiasesLogger`.
            Pass in empty dictionary to use default arguments. For custom logger, the dictionary should have the following
    ...
    def _add_parser_args(cls, parser):
        ...
        parser.add_argument(
            ...
            'Example for command line use: `--log-to-wandb {"project": "text"}`.',
        )
        parser.add_argument(
            "--disable-stdout",
            action="store_true",
