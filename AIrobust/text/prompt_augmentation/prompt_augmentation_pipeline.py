...
class PromptAugmentationPipeline:
    ...
    Args:
        augmenter (text.Augmenter): the augmenter to use to
            augment the prompt
        llm (text.ModelWrapper): the LLM to generate responses
    ...
    def __call__(self, prompt, prompt_constraints=[]):
        ...
        Args:
            ...
            prompt_constraints (List(text.constraints.PreTransformationConstraint)): a list of pretransformation
