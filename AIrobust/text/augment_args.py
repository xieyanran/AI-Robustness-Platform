...
AUGMENTATION_RECIPE_NAMES = {
    "wordnet": "text.augmentation.WordNetAugmenter",
    "embedding": "text.augmentation.EmbeddingAugmenter",
    "charswap": "text.augmentation.CharSwapAugmenter",
    "eda": "text.augmentation.EasyDataAugmenter",
    "checklist": "text.augmentation.CheckListAugmenter",
    "clare": "text.augmentation.CLAREAugmenter",
    "back_trans": "text.augmentation.BackTranslationAugmenter",
    "back_transcription": "text.augmentation.BackTranscriptionAugmenter",
}
