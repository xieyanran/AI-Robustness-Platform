...
class AttackCheckpoint:
    ...
    Args:
        attack_args (text.AttackArgs): Arguments of the original attack
        attack_log_manager (text.loggers.AttackLogManager): Object for storing attack results
    ...
    def __init__(
        ...
        ), "`attack_args` must be of type `text.AttackArgs`."
        assert isinstance(
            attack_log_manager, textattack.loggers.AttackLogManager
        ), "`attack_log_manager` must be of type `text.loggers.AttackLogManager`."
