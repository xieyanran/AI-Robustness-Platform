...
class Augmenter:
    ...
    Args:
        transformation (text.Transformation): the transformation
            that suggests new texts from an input.
        constraints: (list(text.Constraint)): constraints
    ...
    Example::
        >>> from text.transformations import WordSwapRandomCharacterDeletion, WordSwapQWERTY, CompositeTransformation
        >>> from text.constraints.pre_transformation import RepeatModification, StopwordModification
        >>> from text.augmentation import Augmenter
