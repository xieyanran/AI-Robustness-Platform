...
import AIrobust.image.netmodels.resnet as resnet
from AIrobust.image.config import attack_params
...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.CIFAR10('AIrobust/image/data', train=True, download=True, transform=transform),
        batch_size=128, shuffle=True)
    test_loader = torch.utils.data.DataLoader(
        datasets.CIFAR10('AIrobust/image/data', train=False, download=True, transform=transform),
        batch_size=128, shuffle=True)
